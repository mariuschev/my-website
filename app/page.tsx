...
export default function Home() {
  return (
    <header className="hero min-h-screen relative flex items-center justify-center text-center text-white">
  ...
  <div className="absolute inset-0 hero-overlay" />
      ...
      <div className="relative z-10 mx-auto w-full px-6 py-24 sm:py-32">
        <div className="flex justify-center">
          <Image src="/logo.svg" alt="M214 logo" width={120} height={120} priority />
        </div>
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg opacity-90">
          Bienvenue sur le site de l'Association des étudiants et alumni du
          Master 2 Professionnel Droit des affaires - 214 de l'Université Paris
          Dauphine - PSL
        </p>

        <p className="mt-4 text-sm opacity-80">“Le Master de référence pour le droit des affaires” - L'Étudiant</p>

        <div className="mt-10 flex justify-center gap-4">
          <Link href="/accueil" className="btn-primary">
            Accueil
          </Link>
        </div>

        <div className="mt-10 flex justify-center gap-4 text-white/90">
